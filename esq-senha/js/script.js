...
botaoSMS.addEventListener('click', function(){
    botaoEmail.classList.remove('btn-laranja');
    botaoEmail.classList.add('btn-claro');

    botaoSMS.classList.remove('btn-claro');
    botaoSMS.classList.add('btn-laranja');
